      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-300 mb-10 max-w-3xl mx-auto">
            SkyGuyver transforms your customer service with AI-powered phone
            assistants that never sleep. Handle calls, take orders, and book
          ...
          {signupMessage && (
            <p
              className={`mt-4 text-sm ${
                signupMessage.includes("🎉") ? "text-green-400" : "text-red-400"
              }`}
            >
              {signupMessage}
            </p>
